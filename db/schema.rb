...
ActiveRecord::Schema.define(version: 2019_05_28_113446) do
  ...
  create_table "spree_salesmen", force: :cascade do |t|
    t.string "name"
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.datetime "follow_datetime"
    t.index ["bill_address_id"], name: "index_spree_users_on_bill_address_id"
    t.index ["category_id"], name: "index_spree_users_on_category_id"
    t.index ["deleted_at"], name: "index_spree_users_on_deleted_at"
    t.index ["email"], name: "email_idx_unique", unique: true
    t.index ["salesman_id"], name: "index_spree_users_on_salesman_id"
